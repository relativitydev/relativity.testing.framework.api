...
## [7.0.0] - 2024-02-02
### Fixed
- Unimplemented ImportApiService, which previously was implemented by the now-deprecated ImportAPI. This causes most data import strategies to fail.

## [6.1.9] - 2023-05-22

### Updated

- Updated the Newtonsoft.Json dependency to >= 13.0.3 and the Relativity.Testing.Framework dependency to >= 7.2.3.
...
- Setting a user's password to the same value as the existing password no longer causes an error.
...
- Updates to UserAddToGroup and WaitUserDeleted strategies to wait for actions to complete.

## [6.1.2] - 2022-02-07

### Changed

- Increased timeout from 30s to 300s in WaitUserDeletedStrategy to account for K8s containers spin up delays.
...
- Update UserAddToGroupStrategy and UserRemoveFromGroupStrategy to use new endpoints.

## [6.0.1] - 2021-12-13

### Changed

- Disable signed modules in the Windsor container.

## [6.0.0] - 2021-11-26

### Changed

- Relativity.DataExchange.Client.SDK updated to v1.15.30.

## [5.11.2] - 2021-11-09

### Fixed

- IFileField.UploadFile now works with workspace FileFields.

## [5.11.1] - 2021-11-08

### Fixed

- IGroupService.Require no longer creates a group after updating the existing one, when the group to look up is passed in by name.

## [5.11.0] - 2021-10-19

### Changed

- RTF library version updated to v7.1.0.

### Added

- Support for Folder Manager API methods: Create, Update, Delete Unused, Query, Get Workspace Root Folder, Get Subfolders, Get Expanded Nodes, Get Status, Move.
...
- Support for Group Manager V1 API methods: Create, Get, Update, Delete.

### Changed

- IGroupService.Update returns updated group.

## [5.6.1] - 2021-09-30

### Changed

- When creating a workspace, Default Cache Location, Default File Repository, and SQL Server will be selected from the appropriate Resource Pool if left blank.

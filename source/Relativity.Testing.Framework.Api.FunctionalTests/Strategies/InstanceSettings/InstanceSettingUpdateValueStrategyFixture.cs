...
namespace Relativity.Testing.Framework.Api.FunctionalTests.Strategies
{
	...
	internal class InstanceSettingUpdateValueStrategyFixture : ApiServiceTestFixture<IInstanceSettingUpdateValueStrategy>
	{
		private IGetByIdStrategy<InstanceSetting> _getByIdStrategy;

		public InstanceSettingUpdateValueStrategyFixture()
		{
		}

		public InstanceSettingUpdateValueStrategyFixture(string relativityInstanceAlias)

...
{
	[TestOf(typeof(IGetByGuidStrategy<LibraryApplication>))]
	internal class LibraryApplicationGetByGuidStrategyFixture : ApiServiceTestFixture<IGetByGuidStrategy<LibraryApplication>>
	{
		[Test]
		...
		public void Get_Existing()
		{
			...
			var result = Sut.Get(resultbyName.Guids[0]);

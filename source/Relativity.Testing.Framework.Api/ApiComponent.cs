...
namespace Relativity.Testing.Framework.Api
{
	...
	public class ApiComponent : IRelativityComponent, IWindsorInstaller
	{
		...
		/// </summary>
		public const string SupportedRelativityVersionRange = "11.3 - 12.3";
		...
		void IWindsorInstaller.Install(IWindsorContainer container, IConfigurationStore store)
		{
			...
			if (configurationService != null)
			{
				...
				string configuredValue = configurationService.GetValueOrDefault("LoggingLevel", defaultValue).ToLower();

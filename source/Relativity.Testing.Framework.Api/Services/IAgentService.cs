...
namespace Relativity.Testing.Framework.Api.Services
{
	...
	public interface IAgentService
	{
		...
		/// </summary>
		/// <param name="entity">The <see href="https://relativitydev.github.io/relativity.testing.framework/api/Relativity.Testing.Framework.Models.Agent.html">agent</see> entity to create.</param>
		/// <returns>The created <see href="https://relativitydev.github.io/relativity.testing.framework/api/Relativity.Testing.Framework.Models.Agent.html">agent</see> entity.</returns>
		/// <example>
		/// <code>
		...
		/// </list>
		/// </summary>
		/// <param name="entity">The <see href="https://relativitydev.github.io/relativity.testing.framework/api/Relativity.Testing.Framework.Models.Agent.html">agent</see> entity to require.</param>

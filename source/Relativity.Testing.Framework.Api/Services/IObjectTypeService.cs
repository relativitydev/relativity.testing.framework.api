...
namespace Relativity.Testing.Framework.Api.Services
{
	...
	public interface IObjectTypeService
	{
		...
		/// <list type="number">
		/// <item><description>If <see cref="Artifact.ArtifactID"/> property of <paramref name="entity"/> has positive value, gets <see cref="ObjectType"/> by ID and updates it.</description></item>
		/// <item><description>If <see cref="NamedArtifact.Name"/> property of <paramref name="entity"/> have a value, gets <see cref="ObjectType"/> by name and updates it if it exists.</description></item>

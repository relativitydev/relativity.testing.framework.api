...
namespace Relativity.Testing.Framework.Api.Services
{
	internal class ImagingJobService : IImagingJobService
	{
		...
		public long SubmitSingleDocument(int workspaceId, int documentArtifactId, ImagingJobSubmitSingleDocumentRequest imagingJobSubmitSingleDocumentRequest)
			=> _imagingJobSubmitSingleDocumentStrategy.SubmitSingleDocument(workspaceId, documentArtifactId, imagingJobSubmitSingleDocumentRequest);
		...
		public async Task<long> SubmitSingleDocumentAsync(int workspaceId, int documentArtifactId, ImagingJobSubmitSingleDocumentRequest imagingJobSubmitSingleDocumentRequest)
			=> await _imagingJobSubmitSingleDocumentStrategy.SubmitSingleDocumentAsync(workspaceId, documentArtifactId, imagingJobSubmitSingleDocumentRequest).ConfigureAwait(false);

...
{
	internal class ResourcePoolQueryEligibleToAddResourcesStrategy : IQueryEligibleToAddResourcesStrategy
	{
		...
		private QuerySlimResult QuerySlim(ResourcePoolQueryRequest request)
		{
			...
			return _restService.Post<QuerySlimResult>($"relativity.resourcepools/workspace/{request.WorkspaceId}/resource-pools/{request.ResourcePoolId}/query-eligible-{request.ResourceType}-to-add", wrapper);
		}

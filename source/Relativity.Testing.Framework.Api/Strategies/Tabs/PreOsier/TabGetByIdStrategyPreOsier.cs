...
{
	[VersionRange("<12.1")]
	internal class TabGetByIdStrategyPreOsier : IGetWorkspaceEntityByIdStrategy<Tab>
	{
		private readonly IRestService _restService;
		private readonly IObjectService _objectService;

		public TabGetByIdStrategyPreOsier(IRestService restService, IObjectService objectService)
		{
